...
USER_SETTINGS_STATE_MASK = TURN_LOCK_STATE_MASK | COMBOS_ASSIST_STATE_MASK
...
SAVE_FILTERED_CACHED_VA = RUNTIME_V2_CODE_START + PERSISTENCE_SAVE_OFFSET
...
def build_switch_helper(
    ...
    # Preserve MKMSZR user-setting bits while replacing active-box/latch state.
    e.emit(andi("t1", "t1", USER_SETTINGS_STATE_MASK), addu("t1", "t1", "t2"))
