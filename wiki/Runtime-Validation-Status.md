...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor v10/v11 Idle, v14 Turn, and v15 Walk Forward/Backward are runtime-confirmed clean | Raw/type-0 is confirmed across idle, two-frame Turn, and shared seven-frame Walk; v16 composes all four confirmed states in one file, size 0x5DB60 (~64.8 KiB over v11) | Runtime validation of v16 composition; then add Crouch as the next isolated three-frame increment |
