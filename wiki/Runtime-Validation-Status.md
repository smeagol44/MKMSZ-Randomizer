...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor direct replacements through Standing Low Kick are runtime-confirmed clean; v26 confirms Low-Punch chain/crossover behavior and v27 confirms the exact 13-word Standing Low Kick; v20 remains the accumulated raw-size failure case | v27 redirects slot 0x12 to an appended exact retail script, imports six donor frames, and keeps file 0x87 at 0x58944. v25+ proof ROMs use the runtime-confirmed post-legal logo bypass | Standing High Kick next; continue bounded isolated mappings while full-character storage/compression is solved separately |
