...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders the genuine MKT SCCOMBO10 Reptile/male-ninja sprite coherently in MKMSZ with isolated donor palette, opaque black, and clean stock restoration | Corrected host scheduler/action paths; exact retail donor strike/reaction/resource closure; MKT codec-22/24 decode; true SCCOMBO10 geometry 42x95 (+15,-19); MKT Y:X -> MKMSZ X:Y descriptor conversion; 44-byte CI row stride for 42 visible pixels; native temporary palette binding | Full 10→11→12→11→10 donor animation; no-repel shim; translated donor strikes/reactions; completed move port |
