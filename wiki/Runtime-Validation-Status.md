...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor direct replacements through Standing Block and High Punch are runtime-confirmed clean; v20 remains the accumulated raw-size failure case | v26 isolates exact retail Low Punch on the small v11 base, importing five Low-Punch-owned frames plus required High-Punch crossover frames; file 0x87 size 0x5BF88. v25+ proof ROMs use the runtime-confirmed post-legal logo bypass | Runtime validation of v26 Low Punch; then continue standing kicks while full-character storage/compression is solved separately |
