...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor v10 clean idle and destructive v11 are runtime-confirmed; v12 fails before gameplay at Mission Objective before music | v13 keeps the same slots 0x01..0x04 mapping but compresses the twelve added locomotion frames into native type-4 blocks, reducing file 0x87 growth from +0x148C0 to +0x6F20 over v11 | Runtime validation of v13 stage load and locomotion batch; then ground combat/aerial imports and semantic labeling of MKMSZ's 43 secondary slots |
