...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor v01-v05 runtime-confirm the genuine five-frame Sektor stance itself, but v02/v03/v05 hard-hang on the same forward/crouch/air-forward paths; v04's pre-game hang was caused by its added diagnostic HUD, since v05 loads normally without that HUD | Corrected host scheduler/action paths; exact donor resource closure; codec conversion; Sektor retail 1/3/5/7/9 stance; native-cursor-at-+0x2EC strategy rejected as a hang fix; v06 removes only the donor-rate hook | Runtime validation of Sektor v06; separate idle-entry palette/shape ordering artifact; full 10→11→12→11→10 donor animation; no-repel shim; translated donor strikes/reactions; completed move port |
