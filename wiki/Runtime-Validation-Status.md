...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor direct replacements through both crouch kicks and Uppercut are runtime-confirmed clean; v20 remains the accumulated raw-size failure case | v24 isolates Standing Block on the v11 base using exact CUT_FRAME `RBHIBLOCK1, RBHIBLOCK3, RBHIBLOCK3`, file 0x87 size 0x503E0 | Runtime validation of v24; then High Punch and Low Punch on compact branches while full-character storage/compression is solved separately |
