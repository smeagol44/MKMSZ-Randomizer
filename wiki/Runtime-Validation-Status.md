...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor direct replacements through Low Punch are runtime-confirmed clean; v26 confirms the Low-Punch chain/crossover behavior; v20 remains the accumulated raw-size failure case | v27 isolates exact retail Standing Low Kick on the small v11 base, redirects slot 0x12 to an appended 13-word script, imports six donor frames, and keeps file 0x87 at 0x58944. v25+ proof ROMs use the runtime-confirmed post-legal logo bypass | Runtime validation of v27 Standing Low Kick; then Standing High Kick while full-character storage/compression is solved separately |
