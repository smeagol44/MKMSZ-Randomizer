...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor direct replacements through Standing Block are runtime-confirmed clean; v20 remains the accumulated raw-size failure case | v25 adds all seven High-Punch-owned Sektor frames on the confirmed v24 base, file 0x87 size 0x5DA0C; two semantic Low-Punch crossover frames remain stock by design. v25+ proof ROMs also use the runtime-confirmed post-legal logo bypass | Runtime validation of v25 High Punch; then isolate Low Punch while full-character storage/compression is solved separately |
