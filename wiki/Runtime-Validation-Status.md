...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; A1/A1.1 genuine SCCOMBO10 path renders deterministically; A1.2 confirms isolated donor palette ownership with stock Sub-Zero colors preserved before/after | Corrected host scheduler/action paths; exact retail donor strike/reaction/resource closure; MKT codec-22/24 decode; donor X-major -> MKMSZ row-major conversion; exact 95x42 (+15,-19) donor geometry; target frame setup copies that geometry without scaling | A1.3 opaque-black fidelity; full 10→11→12→11→10 animation; no-repel shim; translated donor strikes/reactions; completed move port |
