...
| Reverse Elbow / MKT port | v6 host-action lifecycle repeats without global hang; v08/A1.7 renders genuine SCCOMBO10; Sektor v10 runtime-confirms the clean idle swap; destructive v11 is also runtime-confirmed | v12 statically imports the exact retail Sektor walk-forward, walk-backward, turn and duck scripts/frames into direct primary slots 0x01..0x04, preserving v10 frame-setup palette binding and false-cave fix | Runtime validation of v12 locomotion batch; then ground combat/aerial imports and semantic labeling of MKMSZ's 43 secondary slots |
