...
| Runtime V2 code/state split | code `[0x801AF420,0x801AF720)`; state `[0x801AF720,0x801AF820)` | [Memory map](Memory-and-Allocation-Map); composition in [Core runtime](Core-Runtime-and-Address-Database) |
