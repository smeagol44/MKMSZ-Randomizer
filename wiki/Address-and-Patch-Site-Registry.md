...
| `0x00063704` | — | XP progression UI | JAL `0x80073E74` | Suppress combo EXPERIENCE label |
| `0x00063724` | — | XP progression UI | JAL `0x80073E74` | Suppress combo EXPERIENCE value |
...
| payload `+0x200` | cached `0x801AF620` / uncached `0xA01AF620` | XP progression | zero extension before overlay | Progression callback entry; table/restore helper follow |
