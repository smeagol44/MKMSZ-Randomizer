...
| `0x00077480..0x000775DB` | GAME SETTINGS right-edit body | Production GAME SETTINGS frontend | guarded stock edit body | Compact TURN/COMBOS/SPECIALS/JUMP right-edit dispatcher plus JUMP draw helper |
| `0x00077600..0x0007769B` | GAME SETTINGS left-edit body | Production GAME SETTINGS frontend | guarded stock edit body | Compact TURN/COMBOS/SPECIALS/JUMP left-edit dispatcher |
| `0x00077888..0x0007790F` | GAME SETTINGS value draws | Production GAME SETTINGS frontend | guarded stock Lives/Continues draw bodies | Draw COMBOS and SPECIALS enum values at compact coordinates |
...
| `0x000AF824..0x000AF833` | GAME SETTINGS cursor coordinate table | Production GAME SETTINGS frontend | guarded stock type-2 four-entry table | Compact cursor coordinates for TURN/COMBOS/SPECIALS/JUMP; EXIT maps to stock OPTIONS cursor type 0/index 5 |
