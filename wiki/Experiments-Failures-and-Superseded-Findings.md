...
| Sektor missile v88: treat early descriptor/cursor binding as sufficient first-frame readiness | v88 keeps the correct v87 rocket/palette and still shows one frame of corrupted Sektor-like texture before the missile | `0x800304C0/0x8001BDA0` update descriptor/render state but texture pixels are uploaded later through the deferred `+0xFA -> 0x800185B8 -> 0x8001D6EC` path. v84's apparent first-frame suppression was confounded by selector zero. Test texture-slot readiness explicitly. | [Player actions and special moves](Player-Actions-and-Special-Moves), [Sektor takeover proof history](Sektor-Takeover-Proof-History) |
