...
| Direction-facing control proof v03/v04 | The visible standalone Turn remained even when `0x8003D86C` was player-gated and then made an unconditional return | `0x8003D86C` is not the source of the observed player-facing toggle; the real path is the player loop's direct `+0x8C XOR 0x10` block at `0x80029A44..0x80029A70` | [Player actions and special moves](Player-Actions-and-Special-Moves) |
