...
| Direction-facing control proof v03 | Standalone Turn still visibly turned Sub-Zero | Comparing current action actor against persistent player-controller actor `0x802C1AC0` was not a sufficient suppression gate; keep the v02 locomotion result, but reject this identity-gating strategy | [Player actions and special moves](Player-Actions-and-Special-Moves) |
