...
| Direction-facing control proof v03-v06 | v03/v04 suppressing `0x8003D86C` had no visible effect; v05 patched one direct Turn-toggle branch; v06 patched both matching branches; Turn still visibly changed facing every press | Static pattern matching did not identify the live writer on the tested route. Stop speculative Turn patches and capture the actual actor-`+0x8C` write PC at runtime before another ROM build. | [Player actions and special moves](Player-Actions-and-Special-Moves) |
