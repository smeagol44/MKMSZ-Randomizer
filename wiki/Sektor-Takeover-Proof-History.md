...
- **Run branch v05 — Implementation/static-confirmed compact physical repack; Runtime Pending.** `MKMSZR_sektor-run-compact-six-pose_common-proof_v05.z64`, SHA-256 `3073bd0b77e88a8bb1ea22a5a45ce1fe933512434188e9c578c35adb4f4f5363`, CRC1/CRC2 `A624B5FA / 2240BC7D`; builder `MKMSZR_build_sektor_run_compact_six_pose_v05.py`. v05 preserves the Runtime-confirmed v04 live Run grammar and target rate 3, but physically removes the six WIMP-derived even Run poses and removes all PS1/WIMP Run build dependencies. The generated corpus is 152 frames, 64 models, 40,577 shared patterns, table `0x33289`, padded streams `0x12FA0`, and file `0x87 = 0x4CD68`, exactly reproducing the prior static-removal estimate and leaving `0x17DC` below the bounded v49 comparison footprint. Two clean builds are byte-identical; every generated Type-5 frame passes the builder's independent round-trip verification. Runtime regression remains required.
