...
| v89 | **Implementation/static-confirmed; Runtime Pending** | Prepares the finalized projectile texture slot synchronously with native `0x8001BF70` before stock actor-list insertion, then refreshes frame state and preserves the v87 rocket palette. |
