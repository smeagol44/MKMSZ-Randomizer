...
| `0x8001F7A8` | Gameplay textured-node renderer | Static/runtime-confirmed | Used by the gameplay HUD queue. Node `+0x4A` is texture-slot ID (v09/v10 runtime-confirmed); node `+0x4C` is palette selector. Palette selector resolves through `0x80290A00 + id*8` to a palette index, then through pointer table `0x802E73E0 + index*4` to the CI8 TLUT. v15 runtime-confirms a dynamic `0x200..0x2FF` texture slot can render genuine Toasty pixels through this path. |
