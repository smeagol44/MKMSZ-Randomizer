...
- [Home](Home)
- [Contributor start here](Contributor-Start-Here)
- [Project status](Project-Status)
- [Architecture](Architecture-Overview)
- [Research synthesis](Complete-Research-Synthesis)
- [Validation matrix](Runtime-Validation-Status)

**Registries and maps**

- [Quick addresses](Address-Quick-Reference)
- [Runtime/memory map](Runtime-and-Memory-Map)
- [ROM/resource map](ROM-Overlay-and-Resource-Map)
- [Function registry](Function-Registry)
- [Patch-site registry](Address-and-Patch-Site-Registry)
- [Structures/encodings](Data-Structures-and-Encodings)
...
- [Catalog overview](Stage-Catalogs)
- [Temple](Stage-Catalog-Temple)
- [Wind](Stage-Catalog-Wind)
- [Water](Stage-Catalog-Water)
- [Earth](Stage-Catalog-Earth)
- [Prison](Stage-Catalog-Prison)
- [Fire](Stage-Catalog-Fire)
