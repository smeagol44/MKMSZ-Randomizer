...
| <code>rom.production.toasty_file_entry_1a</code> | <code>[0x000A5148, 0x000A5154)</code> | <code>production</code> | Toasty expansion file-table entry <code>0x1A</code> | Global file table | Stage init | v47 Runtime-confirmed full production composition; CI guards/bounds | conditional | <code>toasty.py</code> | Owned only when donor-derived Toasty assets are supplied; existing normal builds leave this clean zero entry untouched. |
| <code>rom.production.toasty_module</code> | <code>[0x00F68000, 0x00F6B320)</code> | <code>production</code> | Packed Toasty code/TLUT/tables/state/CI8 slices | Global high ROM | Stage init / gameplay | v47 Runtime-confirmed full production composition | conditional | <code>toasty.py</code>, <code>toasty_codegen.py</code> | Ends after optional rainbow file-87 ownership and before title ownership. |
| <code>rom.production.toasty_audio_sample</code> | <code>[0x00F6B320, 0x00F6BB36)</code> | <code>production</code> | Confirmed MKT Toasty encoded sample | Global high ROM | Gameplay audio | v47 Runtime-confirmed full production composition | conditional | <code>toasty.py</code> | Donor bytes are supplied at build time and are not stored in the repository. |
