...
| <code>rom.production.payload_source</code> | <code>[0x00F10000, 0x00F10300)</code> | <code>production</code> | MKMSZR Runtime V2 reloadable code payload | Generated ROM output | Stage init reload; runtime code | Runtime-confirmed; Implementation/CI-confirmed exactly <code>0x300</code> bytes | yes | <code>native_payload.py</code>, <code>runtime_v2.py</code>, <code>xp_progression.py</code> | File <code>0x1B</code> points here. Source bytes being <code>FF</code> in the clean ROM are only a guard, not the reason this ownership is accepted. |
...
| <code>rdram.production.xp_payload</code> | <code>[0x1AF620,0x1AF720)</code> | KSEG0 <code>[0x801AF620,0x801AF720)</code>; KSEG1 <code>[0xA01AF620,0xA01AF720)</code> | <code>production</code> | XP progression callback, threshold table, restore helper | Reserved MKMSZR block | Pickup / stage transition | Runtime-confirmed Diagnostic B behavior; CI-confirmed <code>0x100</code> | yes | <code>xp_progression.py</code> payload <code>+0x200..+0x300</code> | V2 code region ends at <code>0x1AF720</code>. |
| <code>rdram.production.state_header</code> | <code>[0x1AF720,0x1AF740)</code> | KSEG0 <code>[0x801AF720,0x801AF740)</code>; KSEG1 <code>[0xA01AF720,0xA01AF740)</code> | <code>production</code> | <code>MKSV</code> V2 state header | Persistent MKMSZR state | Survives payload reload / normal stage lifecycle | Runtime-confirmed V2 state; CI-confirmed layout | yes | <code>runtime_v2.py</code> header size <code>0x20</code> | Header validates magic/version/size/header-size. |
| <code>rdram.production.pickup_state</code> | <code>[0x1AF740,0x1AF760)</code> | KSEG0 <code>[0x801AF740,0x801AF760)</code>; KSEG1 <code>[0xA01AF740,0xA01AF760)</code> | <code>production</code> | Eight stage ordinary-pickup bitset words | Persistent MKMSZR state | Run lifecycle until reset boundary | Runtime-confirmed representative persistence in all eight stages | yes | <code>pickup_persistence.py</code> descriptors use state offsets <code>+0x20..+0x3C</code> | Scripted/special mechanisms are outside these bitsets. |
...
- ROM bounded current coverage: <code>0xEF7D8</code> bytes (980,952 bytes), about **5.85%** of the 16 MiB image.
