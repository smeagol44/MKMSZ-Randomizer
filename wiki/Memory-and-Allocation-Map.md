...
| <code>rom.production.shared_file_entry_1a</code> | <code>[0x000A5148, 0x000A5154)</code> | <code>production</code> | Shared TURN/Toasty expansion file-table entry <code>0x1A</code> | Global file table | Stage init | TURN production composition Runtime-confirmed; CI guards/bounds | yes | <code>game_settings_turn.py</code>, <code>toasty.py</code> | TURN owns the mandatory low-prefix module; optional Toasty extends the same file while preserving the shared start. Frontend does not load this file. |
