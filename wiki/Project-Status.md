...
| Toasty visual | **Runtime-confirmed image + compact-layout proof; feature-core proof pending runtime.** v38 is perfect across all eight safe stages; v40's compact uncached expansion architecture works on the user-tested route. v41 adds the real 6/32/16 slide/hold/slide-out state machine, Block+Use temporary trigger, and one-shot composition with the already-confirmed Toasty voice. | v41 is Implementation/static-confirmed pending manual runtime validation. Its audio host still deliberately reuses the disposable v03 pickup-event route; dedicated production audio routing and the final uppercut/contact + 4% trigger remain Pending. See [Toasty visual research](Toasty-Visual-Research) |
