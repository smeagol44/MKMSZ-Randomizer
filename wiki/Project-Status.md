...
| Reverse Elbow host/action proof + genuine MKT import branch | v6 established repeatable scheduler/action stability; v08/A1.7 runtime-confirmed genuine SCCOMBO10; Sektor direct replacements through both crouch kicks and Uppercut are runtime-confirmed; v20 remains the accumulated raw-resource failure boundary | Runtime-test isolated v24 Standing Block, then continue High Punch and Low Punch on compact branches while the full-character storage/compression problem is solved separately |
