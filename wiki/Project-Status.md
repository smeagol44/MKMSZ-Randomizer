...
- **Toasty:** audio identification/playback is Runtime-confirmed in v03. Visual v15 confirms the image/texture path; v16 palette binding is not yet runtime-confirmed. Detailed visual diagnostics are canonical in [Toasty visual research](Toasty-Visual-Research); audio remains on its current audio owner.
