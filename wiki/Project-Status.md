...
| Toasty visual | **Runtime-confirmed image, compact layout, and feature core.** v38 is perfect across all eight safe stages; v40 validates the compact uncached expansion layout; v41 Runtime-confirms the composed slide/hold/slide-out + one-shot voice path under the temporary Block+Use trigger. v42 adjusts only presentation: lower-right alignment and half-duration 3/16/8 timing. | v42 is Implementation/static-confirmed pending manual runtime validation. Dedicated production audio routing and the final uppercut/contact + 4% trigger remain Pending. See [Toasty visual research](Toasty-Visual-Research) |
...
- **Toasty:** audio v03, visual v38, compact layout v40, and composed feature core v41 are Runtime-confirmed on their documented routes. v42 is the current presentation-only adjustment: move the 78x85 hold rectangle to `(242,155)..(320,240)` and halve timing to 3/16/8 ticks with 26-pixel slide steps. Expansion use remains 1,744 bytes (`0x3530` free). Dedicated production audio routing and the real uppercut/contact + 4% gate remain Pending. Detailed evidence is canonical in [Toasty visual research](Toasty-Visual-Research).
