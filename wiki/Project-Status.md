...
| MKT fighter / Sektor takeover | **Runtime-confirmed proof line through v87; v88 is Implementation/static-confirmed and Runtime Pending; v85 remains built but untested and statically rejected for the ordinary straight branch.** v62 remains the stable combo baseline; v75 remains the stable missile-flight baseline. v86 proves projectile-local dynamic palette ownership matters. v87 combines exact retail ROCKETD1 indices with exact retail ROCKET_P and Runtime-confirms the flying missile's donor-faithful colors; its remaining one-frame corruption is the earlier Ice/Sektor descriptor rendered through the new rocket palette. v84 had already proven that a contextual pre-insertion rocket advance removes that first Ice-derived frame, but used selector zero. v88 combines those two independently supported seams while preserving v75 helpers, placement, child ownership, flight, collision and cleanup. Helpers, strike/effects/audio, balanced palette release and final integration remain pending. | Proof-only, including bootstrap allocation overlap. Preserve the generic donor→MKMSZ adapter; see [Sektor takeover proof history](Sektor-Takeover-Proof-History), [MKT adapter primitives](MKT-Adapter-Primitives), and [Player actions and special moves](Player-Actions-and-Special-Moves). |
...
- **Sektor:** v62 remains the tested combo baseline; v75 the last stable tested straight-missile flight. v76–v79 remain negative/failed controls. v80–v84 are runtime observed with distinct frame/palette results; v85 is statically rejected and untested. v86 partially validates dynamic palette ownership. v87 Runtime-confirms the exact retail ROCKETD1 + ROCKET_P asset pair: the flying rocket colors are correct, while the earlier Ice-derived one-frame projectile becomes a palette-mismatched/glitched Sektor. v88 is the pending composition of v87's correct dynamic rocket palette with v84's first-visible contextual rocket advance, without selector zero.
