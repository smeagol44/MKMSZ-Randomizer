...
| Reverse Elbow host/action proof + genuine MKT import branch | v6 established repeatable scheduler/action stability; v08/A1.7 runtime-confirmed genuine SCCOMBO10; Sektor direct replacements through Crouch Low Kick are runtime-confirmed; v20 confirms an accumulated raw-resource failure boundary above v19's working size | Runtime-test compact v22 Crouch High Kick + confirmed Low Kick; continue isolated mapping while investigating proper fighter storage/compression before another large composition |
