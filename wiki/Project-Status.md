...
- **Sektor Run — cadence + variable-length script (2026-09-25; Runtime-confirmed) / compact storage (Runtime Pending):** retail MKT Sektor primary slot `0x4A -> +0x1444` contains only `RBRUN1,3,5,7,9,11`. v03 Runtime-confirms target rate **3** as the donor-equivalent cadence; v04 Runtime-confirms an exact six-visual-entry live Run followed immediately by loop control. v05 (`MKMSZR_sektor-run-compact-six-pose_common-proof_v05.z64`, SHA-256 `3073bd0b77e88a8bb1ea22a5a45ce1fe933512434188e9c578c35adb4f4f5363`) now physically removes the six obsolete even Run poses and PS1/WIMP Run dependencies while preserving the v04 semantics. The v05 build exactly matches the prior static footprint prediction: 152 frames, 40,577 patterns, file `0x87 = 0x4CD68`, `0x17DC` below the bounded v49 comparison footprint. v05 is Implementation/static-confirmed and awaits manual runtime regression before the compact storage route is promoted.
