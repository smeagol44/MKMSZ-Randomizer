"""Build the disposable eight-stage ordinary-pickup persistence ROM."""
...
from mkmszr.patches.generalized_persistence import generalized_persistence_test_patches
...
def main() -> int:
    ...
    results = PatchPipeline(generalized_persistence_test_patches()).apply(
        rom, PatchContext()
    )
